...
Route::group(array('prefix' => 'trading-center'),function()
{
	...
	// 聊天记录
	Route::group(array('prefix' => 'chatmsgs'),function()
	{
		Route::post('create', 'ChatmsgController@create');
		Route::post('read', 'ChatmsgController@read');
		Route::get('unread/count', 'ChatmsgController@getNumOfUnreadChatmsgs');
		Route::get('all', 'ChatmsgController@getMyChatmsgs');
	});
...
Route::group(array('prefix' => 'admin','before' => 'auth.user.isAdmin'),function()
{
	...
	Route::post('updateProduct','ProductController@updateProduct');
	Route::post('passAuthentication','SellerAuthenticationController@pass');
	Route::post('failAuthentication','SellerAuthenticationController@fail');
});
