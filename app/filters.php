...
{
    if ( Auth::check()){
        $ckname = uth::getRecallerName(); //Get the name of the cookie, where remember me expiration time is stored
...
Route::filter('auth.user.isOut',function()
{
	if(Sentry::check())
	{
		return Response::json(array('errCode' => 10,'message' => '请退出！'));
	}
});
