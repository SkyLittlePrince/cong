...
@section('css')
    @parent
    <link rel="stylesheet" type="text/css" href="/dist/css/bountyHunter/auction/step-4.css">
@stop
...
@section('body')
    ...
    <div id="main">
        ...
        <div class="step4 auctionstep">
            ...
            <div class="next-step">
                <a href="/bounty-hunter/auction?step=3" class="btn last">上一步</a>
                <a href="/bounty-hunter/auction?step=5" class="btn next">下一步</a>
            </div>
        </div>
    </div>
