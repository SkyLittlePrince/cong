...
@section('css')
    @parent
    <link rel="stylesheet" type="text/css" href="/dist/css/bountyHunter/rewardtask/step-2.css">
@stop
...
@section('body')
    ...
    <div id="main">
        ...
        <div class="step2 rewardtaskstep">
            ...
            <div class="next-step">
                <a href="/bounty-hunter/reward-task?step=1" class="btn last">上一步</a>
                <a href="/bounty-hunter/reward-task?step=3" class="btn next">现在支付</a>
            </div>
        </div>
    </div>
